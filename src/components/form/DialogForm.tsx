  ...
  (
    ...
    <DialogFormPortal>
      ...
      <DialogPrimitive.Content
        ...
        title="Pop up"
        className={cn(
          "fixed left-[50%] top-[50%] z-50 w-full max-w-[52%] h-[85vh] translate-x-[-50%] translate-y-[-50%] border border-neutral-200 bg-white shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg",
          className
        )}
        {...props}
      >
        <div className="flex h-full">
          {/* Left column (40%) */}
          <div className="w-2/6 p-6 bg-neutral-50 rounded-l-lg flex flex-col overflow-y-auto">
            ...
            <div className="space-y-2 flex-grow">
              {tabs.map((tab, index) => (
                <button
                  ...
                  className={`flex items-center w-full text-left p-2.5 rounded-lg text-neutral-600  ${
                    currentStep === index + 1
                      ? "bg-neutral-100 font-bold border border-neutral-200"
                      : "hover:bg-neutral-100 font-medium"
                  }`}
                >
                  <span
                    className={`${

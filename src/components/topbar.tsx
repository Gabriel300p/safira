...
export default function Topbar({ title, subtitle }: Links) {
  ...
  return (
    <div className="px-6 py-5 bg-white justify-between items-center flex rounded-xl  fixed top-0 z-50 border-b border-neutral-300 shadow backdrop-blur w-[88%] sm:w-[83%]">
